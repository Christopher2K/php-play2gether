        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Créer une rencontre</h2>
                    <hr />
                    <h3 class="large text-muted">Créer une partie afin que les autres joueurs te rejoignent</h3>
                </div>
            </div>
                <form method="post" action="resultat.php" id="inscription">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="titre" required data-validation-required-message="Veuillez renseigner le titre de l'annonce'" placeholder="Titre de l'annonce">
                        </div>
                      <div class="form-group">
             ...
             <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="dateEvenement">Date de la rencontre</label>
                    <input type="date" class="form-control" id="dateEvenement" required data-validation-required-message="Veuillez renseigner la date de la rencontre" placeholder="Date">
                </div> 
                <div class="form-group">
                    <label for="nbJoueurs">Nombre max de joueur</label>
                    <input type="number" class="form-control" id="nbJoueurs" min="1" required data-validation-required-message="Veuillez renseigner votre prénom" placeholder="Nombre maximum de joueur">
                </div>    
            </div>
            <div class="col-md-12">
                <div class="form-group">
