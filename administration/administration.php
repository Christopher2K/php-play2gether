    ...
    <div id="page">
        ...
        <div id="articles">
            ...
            <div class="article">
                ...
                <h2>Statistiques</h2>
                <p>Obtenez des statistiques sur le site ici : Nombre d'annonces, d'utilisateurs et même le sport le plus
                    pratiqué avec son nombre d'annonces.</p>
            ...
            <div class="article">
                ...
                <h2>User Manager</h2>
                <p> Obtenez ici la liste des utilisateurs. Vous pouvez aussi modifier, supprimer ou ajouter un
                    utilisateur/administrateur.</br></br></p>
            ...
            <div class="article">
                ...
                <p>Obtenez ici la liste des annonces.
                    Vous pouvez aussi lancer une campagne de Mails pour promouvoir des annonces dans une région ou dans
                    un sport.</p><br>
